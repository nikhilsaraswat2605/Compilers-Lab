...
type_specifier:
                ...
                | _BOOL
                    {
                         #ifdef _DEBUG
                            printf("INFO [Line %d] : type_specifier => _Bool\n",lineCount); 
                            #endif
                    }
                | _COMPLEX
                    {
                         #ifdef _DEBUG
                            printf("INFO [Line %d] : type_specifier => _Complex\n",lineCount); 
                            #endif
                    }
                | _IMAGINARY
                    {
                         #ifdef _DEBUG
                            printf("INFO [Line %d] : type_specifier => _Imaginary\n",lineCount); 
                            #endif
                    }
                | enum_specifier 
                    {
...
parameter_declaration:
                        declaration_specifiers declarator
                            { 
                                #ifdef _DEBUG
                                    printf("INFO [Line %d] : parameter_declaration => declaration_specifiers declarator\n",lineCount); 
                                    #endif
                            }
                        | declaration_specifiers
                            { 
